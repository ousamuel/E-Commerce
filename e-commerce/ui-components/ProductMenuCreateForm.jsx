...
import { createProductMenu } from "../../src/graphql/mutations";
const client = generateClient();
export default function ProductMenuCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setUpdatedTime(initialValues.updatedTime);
    setErrors({});
  };
  const validations = {
    productName: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createProductMenu.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ProductMenuCreateForm")}
      {...rest}
    >
      <TextField
        label="Product name"
